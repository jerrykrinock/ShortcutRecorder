...
#define ShortcutRecorderAllFlags ShortcutRecorderEmptyFlags | (NSEventModifierFlagCommand | NSEventModifierFlagOption | NSEventModifierFlagControl | NSEventModifierFlagShift | NSFunctionKeyMask)
