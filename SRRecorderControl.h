...
/*!
 @brief    The attribute ignoreThisAppValidation says whether or
 not to ignore the current application when validating shortcuts
 entered by the user.
 
 @details  The default value is NO.  However, if the shortcut
 being entered is designed to be used when the user is in another
 app, what you might call a "cross-app shortcut", then you may
 want to set this value to YES.
 */
- (BOOL)ignoreThisAppValidation;
- (void)setIgnoreThisAppValidation:(BOOL)flag;
