...
NSString * SRStringForCarbonModifierFlags( NSUInteger flags )
{
    NSString *modifierFlagsString = [NSString stringWithFormat:@"%@%@%@%@", 
                                     ( flags & controlKey ? [NSString stringWithFormat:@"%C", (unichar)(unsigned short)KeyboardControlGlyph] : @"" ),
                                     ( flags & optionKey ? [NSString stringWithFormat:@"%C", (unichar)(unsigned short)KeyboardOptionGlyph] : @"" ),
                                     ( flags & shiftKey ? [NSString stringWithFormat:@"%C", (unichar)(unsigned short)KeyboardShiftGlyph] : @"" ),
                                     ( flags & cmdKey ? [NSString stringWithFormat:@"%C", (unichar)(unsigned short)KeyboardCommandGlyph] : @"" )];
