    ...
    if (style == SRGradientBorderStyle) {
        ...
        //	if (isVaguelyRecording)
        {
            ...
            /*
             ...
             if (mouseInsideTrackingArea)
             {
             [[[NSColor controlTextColor] colorWithAlphaComponent: alphaRecording*(mouseDown ? 0.15 : 0.1)] set];
             [snapBackButton fill];
             }*/
...
{
    return [validator ignoreThisAppValidation];
}

- (void)setIgnoreThisAppValidation:(BOOL)flag
{
    [validator setIgnoreThisAppValidation:flag];
}
